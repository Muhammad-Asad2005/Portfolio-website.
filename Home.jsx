      ...
      <div className='relative z-10 h-full w-full max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2'>
        <div className='flex flex-col justify-center h-full text-center lg:text-left relative'>
          <div className='w-full lg:pr-24 mx-auto max-w-[48rem]'>
            ...
            <motion.h1 
              className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font text-transparent bg-clip-text bg-gradient-to-r from-[#1cd8d2] via-[#00bf8f] drop-shadow-lg"
            ...
            >
              <a 
                href="#projects"
                className='px-6 py-3 rounded-full font-medium text-lg text-white bg-gradient-to-r from-[#1cd8d2] via-[#00bf8f] to-[#302b63] shadow-lg hover:scale-105 transition-all duration-300'
              >
                View My Work
              </a>
              <a 
        ...
        <div className='relative hidden lg:block'> 
          <div
            ...
            style={{
              ...
              filter: "blur(38px)",
              opacity: 0.32,
              background: "conic-gradient(from 0deg, #1cd8d0, #00bf8f, #302b63, #1cd8d2)"
            }}
          />
